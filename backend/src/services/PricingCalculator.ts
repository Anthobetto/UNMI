...
export interface PricingTier {
  ...
  dailyMessageCap: number; // Max messages per day
  minMessages: number; // Min messages to start
  features: string[];
  locationMultiplier: number; // Discount for multiple locations
}
...
export class PricingCalculator {
   ...
   */
  calculateSavings(
    currentTierId: 'starter' | 'professional',
    dailyMessages: number,
    locations: number
  ): number {
